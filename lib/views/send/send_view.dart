        ...
        children: [
          ...
          SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Obx(() => _buildVehicleOption('mai_send_motor', 'Mai-Send Motor', Icons.two_wheeler, 'Maks 20kg')),
                  Obx(() => _buildVehicleOption('mai_send_mobil', 'Mai-Send Mobil', Icons.local_shipping, 'Maks 200kg')),
                ],
              ),
            ),
          ),
          ...
          // Formulir Pengiriman
          TextField(
            onChanged: (val) => orderController.recipientName.value = val,
          ...
          TextField(
            ...
            onChanged: (val) => orderController.recipientPhone.value = val,
            decoration: InputDecoration(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Deskripsi Barang (Contoh: Dokumen / Makanan)',
              hintStyle: const TextStyle(fontSize: 12),
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        '🏷️ Ada promo pengiriman Mai-Send! Ketuk untuk pakai voucher.',
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Ongkir Resmi Kurir', style: TextStyle(fontSize: 12, color: Colors.black54)),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Total Pembayaran Ongkir', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                  ...
                  Row(
                    children: [
                      if (estDuration.isNotEmpty) ...[
                        Icon(Icons.schedule, size: 11, color: isSelected ? AppTheme.primaryBlue : Colors.teal.shade800),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 10.5,
                            fontWeight: FontWeight.bold,
                            color: isSelected ? AppTheme.primaryBlue : Colors.teal.shade900,
                          ),
                        ),
